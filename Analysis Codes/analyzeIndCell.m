function output = analyzeIndCell(subjectName)
    ...
    if strcmp(subjectName, 'All')
        createAllCellType(protocolInfo);
    end
    ...
    %check code if need to add back
                ...
                saveas(figure(negfigure), fullfile(folder, ... 
                    strcat(subjectName, '_', experimentName, '_neg', '.png')));
    ...
    %check code if need to add back
                ...
                saveas(figure(posfigure), fullfile(folder, ... 
                    strcat(subjectName, '_', experimentName, '_pos', '.png')));
    ...
    saveas(figure(1), fullfile(folder, finalfig));
        close(figure(1));
  %  saveas(figure(1), fullfile(folder, 'chisquarelinearfit.png'));
   %     close(figure(1));
end
